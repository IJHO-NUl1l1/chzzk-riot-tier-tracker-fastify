...
import { chzzkPrivacyRoute } from './routes/chzzk/privacy';
import { chzzkTierRefreshRoute } from './routes/chzzk/tier-refresh';
import { chzzkChatChannelRoute } from './routes/chzzk/chat-channel';
import { chzzkChatTokenRoute } from './routes/chzzk/chat-token';
import { chzzkNicknameColorCodesRoute } from './routes/chzzk/nickname-color-codes';
...
app.register(chzzkPrivacyRoute);
app.register(chzzkTierRefreshRoute);
app.register(chzzkChatChannelRoute);
app.register(chzzkChatTokenRoute);
app.register(chzzkNicknameColorCodesRoute);
